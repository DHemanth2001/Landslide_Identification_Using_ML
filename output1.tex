...
\begin{itemize}
    \item \textbf{Image ID:} \texttt{test\_image\_409.jpg}
...
\begin{figure}[H]
    ...
    \fbox{\rule{0pt}{4cm} \rule{4cm}{0pt} \textit{Original Image}} \hspace{1cm}
    \fbox{\rule{0pt}{4cm} \rule{4cm}{0pt} \textit{Grad-CAM Heatmap}}
