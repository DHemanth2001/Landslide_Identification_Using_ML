...
\title{Landslide Identification --- Results 7 \\ \large Focal Loss + Test-Time Augmentation + Grad-CAM}
\author{}
\date{2026-03-17}
    ...
    \begin{tikzpicture}[
        ...
        \node[anchor=north west, font=\small] at (-4.5,-9) {
            \begin{tabular}{ll}
                ...
                \tikz\draw[fill=orange!20, draw, dashed, line width=1.5pt] (0,0) rectangle (0.4,0.3); & \textbf{NEW in results7} \\
            \end{tabular}
        };
    \end{tikzpicture}
    }
...
\begin{table}[H]
    ...
    \begin{tabular}{lccc}
        \toprule
        \textbf{Metric} & \textbf{r5 (Baseline)} & \textbf{r7 (Projected)} & \textbf{Change} \\
        \midrule
...
\begin{table}[H]
    ...
    \begin{tabular}{l|cc|cc}
        \toprule
         & \multicolumn{2}{c|}{\textbf{r5 (Baseline)}} & \multicolumn{2}{c}{\textbf{r7 (Projected)}} \\
        ...
        \bottomrule
    \end{tabular}
    \caption{Confusion matrix: r5 baseline vs r7 projected.}
\end{table}
...
\bottomrule
\end{tabularx}
\caption{New modules created in results7.}
\end{table}
...
\bottomrule
\end{tabularx}
\caption{Existing files modified in results7.}
\end{table}
...
% ============================================================================
\section{Cumulative Comparison: r0 $\to$ r7}
% ============================================================================
...
\rowcolor{bestgreen}
\textbf{r7} & \textbf{+ Focal Loss + TTA + Grad-CAM} & \textbf{86--88} & \textbf{74--76} & \textbf{83--86} & \textbf{78--81} & \textbf{92--94} \\
\bottomrule
\end{tabular}
\caption{Cumulative performance evolution. r6$^*$ = multi-class macro averages (different task). r7 = projected ranges, binary classification.}
\end{table}
